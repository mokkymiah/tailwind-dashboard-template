...
function ArloWidget() {
  ...
  return (
    <>
      ...
      {/* Chat Panel */}
      {open && (
        <div className="fixed bottom-6 right-6 z-50 w-[calc(100vw-1.5rem)] sm:w-[380px] bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-2xl flex flex-col overflow-hidden">
          {/* Header */}
