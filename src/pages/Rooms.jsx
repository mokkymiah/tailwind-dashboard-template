          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-6">
              <div>
                <h1 className="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">
                  Room Allocation Units
                </h1>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                  Track individual unit licensing parameters, resident
                  assignments, localized inventory checks, and specific room
                  maintenance actions.
                </p>
              </div>
              <button
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-xs mb-6 border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row gap-4 items-center justify-between">
              <div className="relative w-full md:w-96">
                ...
                <input
                  type="text"
                  placeholder="Search by Room ID, Property, Resident name..."
                  value={searchTerm}
              ...
              <div className="flex items-center gap-2 w-full md:w-auto justify-end">
                ...
                >
                  <option value="All">All Room Status Profiles</option>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-4 space-y-3">
                <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-wider px-1">
                  Indexed Room Units ({filteredRooms.length})
                </h2>
