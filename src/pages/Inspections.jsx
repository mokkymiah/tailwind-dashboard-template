          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-6">
              <div>
                <h1 className="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold flex items-center gap-2.5">
                  <ClipboardCheck className="text-indigo-600" /> Statutory Inspections & Site Audits
                </h1>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                  Schedule physical hazard checklists, track overdue structural validations, and run automated processing on engineering fields.
                </p>
              </div>
              <button 
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-3xs mb-6 border border-gray-100 dark:border-gray-700 flex flex-col lg:flex-row gap-4 items-center justify-between">
              <div className="relative w-full lg:w-96">
                ...
                <input
                  type="text"
                  placeholder="Search by building location, inspector name, audit code..."
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className="w-full pl-10 pr-4 py-2 border rounded-lg bg-gray-50 dark:bg-gray-700/40 border-gray-200 dark:border-gray-600 text-xs focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-800 dark:text-gray-200"
                />
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto justify-end text-xs font-medium">
                <div className="flex items-center gap-1.5">
                  ...
                  >
                    ...
                    <option value="Due">Overdue Milestone Target</option>
                    <option value="Urgent Review">Urgent Review Required</option>
                  </select>
                </div>
                ...
                <select
                  ...
                  className="bg-gray-50 dark:bg-gray-700/50 border rounded-lg py-1.5 px-2.5 text-gray-700 dark:text-gray-200 focus:outline-none"
                >
                  <option value="All">All Inspection Frameworks</option>
                  <option value="Fire Risk Assessment">Fire Risk Assessment</option>
                  <option value="EICR Structural Audit">EICR Electrical Scope</option>
                  <option value="Legionella Water Quality">Legionella Controls</option>
                  <option value="Asbestos Condition Survey">Asbestos Condition Survey</option>
                  <option value="Elevator Lifting Equipment">Elevator Lifting Systems</option>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-5 space-y-3">
                <div className="flex justify-between items-center px-1">
                  <h2 className="text-xs font-bold text-gray-400 uppercase tracking-wider">Filtered Audits List ({filteredInspections.length})</h2>
                  <span className="text-[10px] bg-gray-200 dark:bg-gray-700 font-mono px-1.5 rounded text-gray-500 dark:text-gray-400">Live Registry</span>
                </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-xs">
            <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-5xl w-full h-[620px] flex flex-col overflow-hidden border dark:border-gray-700 shadow-2xl relative">
              ...
              <div className="grow flex overflow-hidden">
                ...
                <form onSubmit={handleFormSubmit} className="w-1/2 p-5 overflow-y-auto border-r dark:border-gray-700 space-y-4 text-xs">
                  <div>
