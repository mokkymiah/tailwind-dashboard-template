          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-3 sm:mb-6">
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-3 sm:p-4 shadow-xs">
                <p className="text-[10px] sm:text-xs font-semibold text-gray-400 uppercase tracking-wider">Total Inspections</p>
                <p className="text-lg sm:text-2xl font-bold text-gray-900 dark:text-white mt-1">{filteredInspections.length}</p>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-3 sm:p-4 shadow-xs">
                <p className="text-[10px] sm:text-xs font-semibold text-gray-400 uppercase tracking-wider">Scheduled</p>
                <p className="text-lg sm:text-2xl font-bold text-blue-600 dark:text-blue-400 mt-1">{filteredInspections.filter((i) => i.status === "Scheduled").length}</p>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-3 sm:p-4 shadow-xs">
                <p className="text-[10px] sm:text-xs font-semibold text-gray-400 uppercase tracking-wider">Completed</p>
                <p className="text-lg sm:text-2xl font-bold text-emerald-600 dark:text-emerald-400 mt-1">{filteredInspections.filter((i) => i.status === "Completed" || i.status === "Pass").length}</p>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-3 sm:p-4 shadow-xs">
                <p className="text-[10px] sm:text-xs font-semibold text-gray-400 uppercase tracking-wider">Overdue</p>
                <p className="text-lg sm:text-2xl font-bold text-rose-600 dark:text-rose-400 mt-1">{filteredInspections.filter((i) => i.status === "Overdue" || i.status === "Failed").length}</p>
              </div>
            </div>
