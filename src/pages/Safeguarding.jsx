            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-3 sm:p-4 mb-3 sm:mb-6">
              <div className="bg-white dark:bg-gray-800 p-3 sm:p-4 border rounded-xl shadow-3xs flex items-center justify-between">
                <div>
                  ...
                  <span className="text-sm sm:text-2xl font-black font-mono text-rose-600 mt-0.5">
                  ...
                  {filteredIncidents.length === 0 ? (
                    ...
                    filteredIncidents.map((inc) => {
                      ...
                      return (
                        <div
                          key={inc.id}
                          onClick={() => { setSelectedIncident(inc); setMobileDetailOpen(true); }}
                  ...
                  {selectedIncident ? (
                    <>
                      ...
                      <div className="p-5 space-y-5 text-xs grow">
                        ...
                        <div className="grid grid-cols-2 gap-3 sm:p-4 bg-gray-50/40 dark:bg-gray-900/20 p-3 sm:p-4 rounded-xl border border-gray-100 dark:border-gray-800">
                          <div>
              ...
              <div className="grow flex flex-col lg:flex-row overflow-hidden">
                ...
                <div className="w-full lg:w-1/2 bg-gray-50 dark:bg-gray-900/60 flex flex-col h-full overflow-hidden">
                  ...
                  <div className="p-3 bg-rose-50 dark:bg-rose-950/20 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center shrink-0">
                    <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-rose-700 dark:text-rose-400 flex items-center gap-1">
