          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-6">
              <div>
                <h1 className="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold flex items-center gap-2.5">
                  <ShieldAlert className="text-rose-600" /> Safeguarding &
                  Critical Incidents Ledger
                </h1>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                  Corporate risk visibility controls, active mitigation
                  matrices, and structured regulatory logging tracking feeds.
                </p>
              </div>
              <button
              ...
              >
                <Plus size={16} />
                <span>Log Incident Framework</span>
              </button>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-3xs mb-6 border border-gray-100 dark:border-gray-700 flex flex-col lg:flex-row gap-4 items-center justify-between">
              <div className="relative w-full lg:w-96">
                ...
                <input
                  type="text"
                  placeholder="Search by incident reference ID, text descriptors, categories..."
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className="w-full pl-10 pr-4 py-2 border rounded-lg bg-gray-50 dark:bg-gray-700/40 border-gray-200 dark:border-gray-600 text-xs focus:outline-none focus:ring-2 focus:ring-rose-500 text-gray-800 dark:text-gray-200"
                />
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto justify-end text-xs font-medium">
                <div className="flex items-center gap-1.5">
                  ...
                  >
                    <option value="All">All Severity Thresholds</option>
                    <option value="Critical">Critical Scope Only</option>
                    <option value="High">High Severity</option>
                    <option value="Medium">Medium Priority</option>
                    <option value="Low">Low Technical Issues</option>
                  </select>
                </div>
                ...
                >
                  ...
                  <option value="Resolved">Resolved Milestones</option>
                  <option value="Escalated">Escalated Channels</option>
                </select>
              </div>
            </div>
              ...
              <div className="lg:col-span-5 space-y-3">
                <div className="flex justify-between items-center px-1">
                  <h2 className="text-xs font-bold text-gray-400 uppercase tracking-wider">
                    Filtered Records Stream ({filteredIncidents.length})
                  </h2>
